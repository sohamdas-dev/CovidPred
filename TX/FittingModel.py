...
def fittingModel(state_name, indFirstValidRow, indFirstAvailData, indLastAvailData, indLastValidRow, Beta_coeff_manual_setting, lower___for_sample_weights, upper___for_sample_weights):
    #
    ...
    relerr = 1.0e-6
    #
    parameters = [A_fr, A_fd, I2Rrate, E2Irate, N0, epsil, recovRate, x_dot_intercept, inpData, indLastAvailData, Beta_coeff_manual_setting]
    ...
    #
    Forecated_I = list(inpData['I'].iloc[indFirstValidRow:indLastAvailData] / N0)
    ...
    if False:
        ...
        plt.plot([indLastAvailData, indLastAvailData], [0, max(Forecated_I)], '--k')
        plt.plot([indFirstAvailData, indFirstAvailData], [0, max(Forecated_I)], '--k')
        plt.plot([indLastAvailData, indLastAvailData], [0, 0.1], '--k')
        plt.plot([indFirstAvailData, indFirstAvailData], [0, 0.1], '--k')
        legend()
