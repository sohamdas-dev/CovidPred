...
# for i in range(0,100):
    ...
    curr_Forecated_I, curr_t_modified, curr_payoff_matrices_A_fd_and_A_fd = fittingModel_MF(state_name, indFirstValidRow, indFirstAvailData, indLastAvailData, indLastValidRow, curr_Beta_coeff_manual_setting, lower___for_sample_weights, upper___for_sample_weights)
    #
...
# add some iid noise 
unique_forecast['I_data'] = np.random.normal(0,0.00001,len(unique_forecast)) + unique_forecast['I'] # rectify, shape issue, need in vector/list form DONE
unique_forecast['I_data'] = unique_forecast['I'] * N0
...
norm_A_FR_list=[]
for i in range(20):
    indLastAvailData = indFirstAvailData+(i+1)*10
