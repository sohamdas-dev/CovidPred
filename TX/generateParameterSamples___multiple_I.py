...
# for i in range(0,100):
    ...
    #
    if (max(curr_Forecated_I) < 0.1) and (min(curr_Forecated_I) >= 0) and (abs(curr_ratio_A_fd) < 10) and (abs(curr_ratio_A_fr) < 10): # and (curr_ratio_A_fd > -3) and (curr_ratio_A_fr > -3):
        try:
