...
def dataPreparation(state_name, I2HospitalRate, E2Irate, I2Rrate, delay_from_hospital_to_I, N0, S0, n0,
    ...
    def calc_Beta_coeff(inpData):
        ...
        # return curr_Beta
        if inpData["DateMonthYearString"] < '2020-03-31':
            curr_Beta = curr_Beta
        elif (inpData["DateMonthYearString"] >= '2020-03-31') and (inpData["DateMonthYearString"] < '2020-05-25'):
            curr_Beta = 0.5 * curr_Beta  # stay home order
        elif (inpData["DateMonthYearString"] >= '2020-05-25') and (inpData["DateMonthYearString"] < '2020-07-06'):
            curr_Beta = 0.7 * curr_Beta  # re-open restaurants
        elif (inpData["DateMonthYearString"] >= '2020-07-06') and (inpData["DateMonthYearString"] < '2020-11-19'):
            curr_Beta = 0.6 * curr_Beta  # closing restaurants
        elif (inpData["DateMonthYearString"] >= '2020-11-19') and (inpData["DateMonthYearString"] < '2021-03-01'):
            curr_Beta = 0.5 * curr_Beta  # partial lockdown
        else:
